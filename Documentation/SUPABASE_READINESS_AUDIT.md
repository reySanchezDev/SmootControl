...
conexion productiva usa un sesion remota autenticada para cumplir RLS mientras la
...
| Usuario remoto temporal | Ready parcial | sesion remota autenticada confirmado permite escritura RLS; falta Auth por operador real. |
...
| Ventas con detalle historico | Ready parcial | Local conserva producto, categoria, precio/costo y opciones; sender remoto mapea montos y sesion remota. |
...
| --- | --- | --- | --- |
| Alta | Auth remoto aun no es por operador. | En Supabase las ventas/caja/gastos quedan bajo sesion remota, no bajo mesero/cajero real. | Reemplazar sesion remota por login Supabase por operador o guardar columna de operador local adicional en remoto. |
...
trazabilidad en Supabase no dependa del sesion remota.
